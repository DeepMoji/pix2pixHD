...
if __name__ == "__main__":
    ...
    toons_dir = '/home/ubuntu/code/pix2pixHD/datasets/toonify/toons' # should be input later
    raw_dir = '/home/pix2pixHD/datasets/toonify/raw' # should be input later
    aligned_dir = '/home/ubuntu/code/pix2pixHD/datasets/toonify/aligned/'  # should be input later
